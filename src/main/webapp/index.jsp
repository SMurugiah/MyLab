...
<div class="navbar navbar-inverse navbar-fixed-top" role="navigation">
    <div class="container">
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="#">SM's DevOps AWS Lab</a>
        </div>
...
<div class="jumbotron">
    <div class="container">
        ...
        <p><a class="btn btn-primary btn-lg" role="button">Learn more DEMO SM &raquo;</a></p>
...
<div class="container">
    ...
    <footer>
        <p>&copy; SM's devops lab 2023-2024</p>
    </footer>
</div> <!-- /container -->
